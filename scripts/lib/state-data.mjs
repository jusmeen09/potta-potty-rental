...
export const statePlanAgency = {
  Alaska: 'AKOSH', Arizona: 'ADOSH', California: 'Cal/OSHA', Hawaii: 'HIOSH',
...
export const seasonProfiles = {
  ...
  'island-remote': { states: ['Hawaii'], label: 'island-by-island logistics', body: 'Inventory is held per island and moving equipment between them is neither quick nor cheap, so availability must be confirmed for the specific island as well as the ZIP code. Salt air and wind exposure also affect placement and anchoring.' },
};
