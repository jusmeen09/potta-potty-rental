...
- Four rental service pages at `/service/service-name/`

The service pages are generated by `scripts/generate-service-pages.mjs`. The location hub and state pages are generated by `scripts/generate-location-pages.mjs`. Update the generators instead of editing generated HTML by hand.
...
Regenerate all service pages, the location directory, and all state pages:
